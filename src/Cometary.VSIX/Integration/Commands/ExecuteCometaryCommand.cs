...
namespace Cometary.VSIX
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class ExecuteCometaryCommand
    {
        /// <summary>
        /// Gets the instance of the command.
        /// </summary>
        public static ExecuteCometaryCommand Instance { get; private set; }
        ...
        /// Command ID.
        /// </summary>
        public const int CommandId = Ids.ExecuteCommandID;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExecuteCometaryCommand"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        private ExecuteCometaryCommand(CometaryPackage package)
        {
        ...
        {
            Instance = new ExecuteCometaryCommand(package);
        }
