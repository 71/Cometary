...
namespace Cometary.Remote.MSBuild
{
    /// <summary>
    /// Used to enable app-local assembly unification.
    /// </summary>
    /// <seealso href="https://github.com/dotnet/buildtools/blob/master/src/common/AssemblyResolver.cs" />
    /// <seealso href="https://github.com/Microsoft/msbuild/issues/1309" />
    internal static class AssemblyResolver
    {
        static AssemblyResolver()
        {
            Assembly.GetExecutingAssembly().ModuleResolve += AssemblyResolver_ModuleResolve;
            AppDomain.CurrentDomain.AssemblyResolve += CurrentDomain_AssemblyResolve;
        }

        private static Module AssemblyResolver_ModuleResolve(object sender, ResolveEventArgs e) => throw new NotImplementedException();
